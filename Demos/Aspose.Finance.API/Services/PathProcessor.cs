...
namespace Aspose.Finance.API.Services
{
    ...
    public class PathProcessor
    {
        ...
        /// </summary>
        public string SourceFolder => PathSafe.GenerateAndValidate(AppSettings.WorkingDirectory, id);

        /// <summary>
        /// Output folder.
        /// This place is where processed file stores.
        /// </summary>
        public string OutFolder => PathSafe.GenerateAndValidate(AppSettings.OutputDirectory, id);
        ...
        public string GetSourceFilePath(string file) => PathSafe.GenerateAndValidate(AppSettings.WorkingDirectory, id, file);
        ...
        /// <param name="file">File name.</param>
        /// <returns>Path.</returns>
        public string GetOutFilePath(string file) => PathSafe.GenerateAndValidate(AppSettings.OutputDirectory, id, file);
        ...
        /// Filled after GetResultZipped call.
        /// </summary>
        public string ZipFolder => idZip == null ? null : PathSafe.GenerateAndValidate(AppSettings.OutputDirectory, idZip);

        /// <summary>
        /// Path to zip file.
        /// Filled after GetResultZipped call.
        /// </summary>
        public string ZipFile => idZip == null ? null : PathSafe.GenerateAndValidate(AppSettings.OutputDirectory, idZip, FileZip);
        ...
        public static string CreateFolder(string id) => new PathProcessor(id).SourceFolder;
    }
}