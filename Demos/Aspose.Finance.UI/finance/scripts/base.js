...
function requestConversion() {
    ...
    let url = o.APIBasePath + 'AsposeFinanceConversion/Convert?outputType=' + $('#saveAs').val();
    request(url, data);
}
...
function requestViewer(data) {
    ...
    openIframe(generateViewerLink(data), pathname, '/finance/view');
}
...
function requestMerger() {
    ...
    let url = o.APIBasePath + 'AsposeCellsMerger/Merge?outputType=' + $('#saveAs').val();
    request(url, data);
}
    ...
    $.ajax({
        ...
        success: (res) => {
            ...
            if (res.StatusCode === 200) {
                ...
                let pathname = window.location.pathname;
                openIframe(generateEditEditorLink(res), pathname, '/finance/edit');
            } else {
...
function requestNewEditor(data) {
    let pathname = window.location.pathname;
    openIframe(generateNewEditorLink(data), pathname, '/finance/edit');
}
