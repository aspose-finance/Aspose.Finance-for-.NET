(function () {
    ...
    function main($scope, $http, Upload, $templateRequest, $sce, $compile) {
        ...
        var helpDataSource = $sce.getTrustedResourceUrl('/finance/assembly/cellsHelpDataSource.html');
        ...
        var helpTemplate = $sce.getTrustedResourceUrl('/finance/assembly/cellsHelpTemplate.html');
        ...
        $scope.$watch('datasourceFile.file', function (newval, oldval) {
            if (newval !== undefined) {
                var re = /(?:\.([^.]+))?$/;
    ...
    angular.module('AsposeCellsAssemblyApp').controller('Main', main);
})();
