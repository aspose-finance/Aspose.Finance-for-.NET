...
using Aspose.Finance.UI.Models.SEO;
...
namespace Aspose.Finance.UI.Models
{
    public class ViewModel
    {
        ...
        /// "Excel"
        /// </summary>
        public const string financeDefaultTitleAddition = "XBRL/iXBRL";
        ...
        public string PageProductTitleURL => "<a href=\"https://products.aspose.com/finance\">Aspose.Finance</a>";
        ...
        protected string TitleCase(string value) =>
            new System.Globalization.CultureInfo("en-US", false).TextInfo.ToTitleCase(value);
        ...
        public ViewModel(BaseController controller, string app, string extension = null)
        {
            ...
            if (!IsSupportedExtensions(Extension, Extension2) && !AppName.Equals("Conversion"))
            {
        ...
        virtual public string this[string key]
        {
            get
            {
                ...
                if (res.Contains("{"))
                {
                    res = string.Format(res, financeDefaultTitleAddition);
                }
        ...
        protected virtual void SetTitles_Impl()
        {
            ...
            if (string.IsNullOrEmpty(Extension2))
            {
                ...
                string additional = financeDefaultTitleAddition; // Excel
        ...
        protected virtual void SetExtensionsString()
        {
            ...
            else
            {
                ...
                {
                    case "xbrl":
                        ExtensionsString = ".xml|.xbrl.xsd";
                        break;
                    case "ixbrl":
                        ExtensionsString = ".html|.xhtml|.ixbrl|.xsd";
                        break;
                    /*case "html":
                    case "htm":
                    case "mhtml":
        ...
        protected virtual void InitOtherApps(string product)
        {
            ...
            if (!product.Equals("finance")) return;
        ...
        private static readonly Dictionary<string, string> FileFormatLinks = new Dictionary<string, string>
        {
            ...
            {"XML", "https://wiki.fileformat.com/web/xml/"},
            ...
            {"XBRL", "https://wiki.fileformat.com/finance/xbrl"},
            {"IXBRL", "https://wiki.fileformat.com/finance/ixbrl"},
        };
        ...
        private void AddFileFormatLinks()
        {
            ...
            {
                if (ext.Equals("XML") || ext.Equals("HTML") || ext.Equals("XHTML") || ext.Equals("XSD"))
                    continue;
        ...
        protected virtual string PrepareJsonLdBreadcrumbList()
        {
            ...
            list.Add(("finance", "https://products.aspose.app/finance/family"));
            list.Add(($"{AppName}", "https://products.aspose.app/finance/" + AppName.ToLower()));
            ...
            if (!string.IsNullOrEmpty(Extension))
            {
                ...
                list.Add((name, Controller.Request.Url.AbsoluteUri.ToLower()));
            }
        ...
        protected virtual string PrepareJsonLdSoftware()
        {
            SoftwareApplication obj = new SoftwareApplication()
            {
                ...
                SoftwareRequirements = new URL() { Id = "https://docs.aspose.com/display/financenet/System+Requirements" },
                SoftwareHelp = "https://docs.aspose.com/display/financenet/Home"
            };
        ...
        {
            HowTo obj = new HowTo(HowToModel, TitleSub, Title);
            return JsonConvert.SerializeObject(obj);
        }
        ...
        protected virtual void PrepareStructuralDataJson()
        {
            ...
            try
            {
                list.Add(PrepareJsonLdBreadcrumbList());
            ...
            {
                NLogger.LogError(ex, ex.Message, "", ProductFamilyNameKeysEnum.finance, "");
            }
